...
export const content: SiteContent = {
  meta: {
    ...
    description: 'Objevte luxusní parfém vytvořený francouzskými parfuméry. Limitovaná edice — zapište se na čekací listinu a získejte předprodejní cenu 399 Kč.',
  },
  hero: {
    preheadline: 'Limitovaná edice 2026',
    title: 'Zanech stopu',
    subtitle: 'Vůně, po\u00a0které se\u00a0otočí. Jedno stříknutí a\u00a0necháš stopu, na\u00a0kterou lidi kolem\u00a0jen tak nezapomenou.',
    cta: 'To mě zajímá',
  ...
  story: {
    him: {
      ...
      evoke: 'Hřejivé dřevo, špetka koření a\u00a0něco, co\u00a0nedokážou pojmenovat — ale\u00a0nedokážou zapomenout.',
    },
    her: {
      badge: 'Pro ni',
      ...
      evoke: 'Hedvábný květ, dotek vanilky a\u00a0tajemství, které prozradíš jen tomu, kdo se\u00a0přiblíží dost blízko.',
    },
    exclusive: {
  ...
  value: {
    ...
    subtext: 'Znáš ten pocit, kdy se\u00a0po\u00a0tobě otočí a\u00a0zeptají se: „Čím to\u00a0voníš?" Přesně o\u00a0tom mluvím.',
    cards: [
      {
  ...
  offer: {
    ...
    subtext: 'Připravili jsme nabídku, kterou jinde nenajdete. Zapište se na\u00a0čekací listinu a\u00a0odhalíte ji.',
  ...
  waitlist: {
    ...
    subtitle: 'Zápis je zdarma a\u00a0nezávazný. Budeme vás informovat o\u00a0spuštění prodeje.',
